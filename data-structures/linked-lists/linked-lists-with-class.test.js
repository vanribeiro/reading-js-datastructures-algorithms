...
describe('Data Structure: Linked List', () => {
    ...
    test('should return a specific element in the list', () => {
        const list = {"element": "banana", "next": {"element": "maçã", "next": {"element": "pêra", "next": {"element": "abacaxi", "next": {"element": "uva", "next": null}}}}};
    ...
    test('should return the list head', () => {
        const list = {"element": "banana", "next": {"element": "pêra", "next": {"element": "caqui", "next": {"element": "uva", "next": null}}}};
