...
print(cyan(' - min [node] value =>'), tree.min());
print(cyan(' - max [node] value =>'), tree.max(), '\n');

print(cyan(' - MIN [static] value =>'), BinarySearchTree.MIN_VALUE);
print(cyan(' - MAX [static] value =>'), BinarySearchTree.MAX_VALUE);
